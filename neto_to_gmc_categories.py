...
NETO_API_KEY = os.getenv('44f8cQerCSpY7kRUavT95UAhfws2gvnK', '')
NETO_CUSTOMER_ID = os.getenv('ClaudeAi', '')
...
def neto_api_call(action: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    url = "https://api.neto.com.au/rest/v1/"
    
    headers = {
        'X-Neto-API-Key': NETO_API_KEY,
        'X-Neto-API-Version': 'Latest',
